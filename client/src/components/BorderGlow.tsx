...
export type BorderGlowProps = {
  ...
  colors?: string[];
  fillOpacity?: number;
  /** Keep gold border and outer glow visible without hover */
  alwaysGlow?: boolean;
};

/** React Bits BorderGlow — edge glow follows cursor near the border. */
export default function BorderGlow({
  ...
  useEffect(() => {
    if (!alwaysGlow || !cardRef.current) return;
  ...
  return (
    <div
      ...
      className={`border-glow-card${alwaysGlow ? " border-glow-card--always" : ""} ${className}`.trim()}
      style={style}
    >
